...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 158.0, 14.0, 24.0, 24.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 413.0, 130.0, 93.0, 22.0 ],
					"style" : "",
					"text" : "a1 $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "list" ],
					"patching_rect" : [ 106.5, 212.0, 5.0, 100.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 237.0, 93.0, 50.0, 22.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 325.0, 130.0, 76.0, 22.0 ],
					"style" : "",
					"text" : "feedback $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 237.0, 130.0, 71.0, 22.0 ],
					"style" : "",
					"text" : "dampen $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 192.5, 192.0, 248.0, 291.0 ],
					"sono" : 1,
					"style" : ""
				}
...
,
					"patching_rect" : [ 31.0, 192.0, 38.0, 22.0 ],
					"style" : "",
					"text" : "gen~"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 31.0, 402.0, 45.0, 45.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 31.0, 301.0, 60.0, 22.0 ],
					"style" : "",
					"text" : "clip~ -1 1"
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-18", 0 ],
					"midpoints" : [ 40.5, 225.0, 177.0, 225.0, 177.0, 186.0, 202.0, 186.0 ],
					"order" : 0,
					"source" : [ "obj-2", 0 ]
				}
